...
# Old one for installing with pydantic and pydantic-core compiled for wasm
...
uvx --native-tls pip install --target wasm_deps --upgrade -r wasm_deps/requirements.txt
